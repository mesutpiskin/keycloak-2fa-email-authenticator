...
public class EmailAuthenticatorFormFactory implements AuthenticatorFactory {
    ...
    static final List<ProviderConfigProperty> SENDING_CONFIG_PROPERTIES = List.of(
    ...
    public List<ProviderConfigProperty> getConfigProperties() {
        List<ProviderConfigProperty> properties = new ArrayList<>(SENDING_CONFIG_PROPERTIES);
        properties.add(new ProviderConfigProperty(EmailConstants.SHOW_MASKED_EMAIL_ON_OTP_FORM, "Show Masked Email on OTP Form",
                "If enabled, displays a masked version of the user's email address on the OTP login form after the code is sent.",
                ProviderConfigProperty.BOOLEAN_TYPE, String.valueOf(EmailConstants.DEFAULT_SHOW_MASKED_EMAIL_ON_OTP_FORM)));
        properties.add(new ProviderConfigProperty(EmailConstants.SKIP_SETUP, "Treat any user with an email as configured",
